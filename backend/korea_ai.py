...
def stream_chat_response(prompt):
    ...
    curl_command = [
        ...
        "-d", json.dumps({
            "messages": [
                {"role": "system", "content": "You are very elite person, you know that BHOOMI is Bhoomi is a platform that connects people who care about the environment with opportunities to volunteer for meaningful events. As volunteers take part in these activities, they earn points that can be exchanged for valuable rewards, encouraging continued efforts to safeguard our planet. Built on EduChain by OpenCampus, Bhoomi makes environmental action accessible and rewarding for everyone.Empowering a global community to protect our planet through impactful environmental actions.You answers other questions too"},
